...
private:
    ...
    mbed::SPI _spi;
    portability::DigitalOut _chip_select;

    // module rest control
    portability::DigitalInOut _reset_ctl;
    ...
    portability::DigitalOut _rxen;
    portability::DigitalOut _txen;
    ...
    portability::Thread irq_thread;

    // Access protection
    portability::mutex mutex;
