...
public:
	...
	bool sendUBX( uint8_t *msg, uint32_t size);
...
private:
	...
	// UBX Checksum
	bool crc( uint8_t *msg, uint32_t size);

	uint8_t _saveCFG[21] = {0xB5, 0x62, 0x06, 0x09, 0x0D, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00, 0x00,
