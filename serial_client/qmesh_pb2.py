...
_SYSCFGMSG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='voice_frames_per_frame', full_name='SysCfgMsg.voice_frames_per_frame', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='codec2_bitrate', full_name='SysCfgMsg.codec2_bitrate', index=11,
