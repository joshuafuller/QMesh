...
public:
    ...
    RadioEvent(const radio_evt_enum_t my_evt_enum, shared_ptr<LowPowerTimer> my_tmr);

    RadioEvent(const radio_evt_enum_t my_evt_enum, shared_ptr<LowPowerTimer> my_tmr, const uint8_t *my_buf, 
